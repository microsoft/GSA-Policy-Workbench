/**
 * Unified policy table — Tier 1 (UI), see spec.md §3.2.
 *
 ...
 * otherwise it degrades gracefully per spec.md §2.3).
 *
...
const useStyles = makeStyles({
  ...
  // lanes land at the same x on the page, at any window size. See
  // docs/UX-Design-Patterns.md §4. Only the trailing CA lane stays flexible.
  header: {
    display: 'grid',
    gridTemplateColumns:

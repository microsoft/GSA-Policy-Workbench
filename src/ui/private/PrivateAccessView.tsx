...
const useStyles = makeStyles({
  ...
  header: {
    display: 'grid',
    // Fixed swim-lane template — mirrors the IA profile card (UX-Design-Patterns.md §2, §4).
  ...
  // anti-pattern fix documented for IA's expanded rule grid in
  // UX-Design-Patterns.md §3. `minmax(0, …fr)` lanes are safe here because

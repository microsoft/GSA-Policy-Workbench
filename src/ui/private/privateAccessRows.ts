 ...
 *
 * Conditional Access correlation (spec §6.3): an app is "covered" by a CA
 ...
 *
 * IMPORTANT — Private Access app authorization vs. GSA security profiles
 * (architecture.md §6.5): a CA policy that carries a

/**
 * What-If panel — Tier 1 (UI), see spec.md §7 (effective-policy resolver).
 *
...
interface WhatIfPanelProps {
   ...
   * the client-side "stage 1" of What-If (docs/WhatIf-Spec.md §3/§5). An
...
/**
 * Client-side traffic-forwarding acquisition verdict (What-If "stage 1" — see
 * docs/WhatIf-Spec.md §3/§5). Rendered ABOVE the cloud-side outcome, since
